...
class DynamicLinkProvider {
  Future<String> createLink(String id) async {
    final String url = "https://com.example.poll_application?id=$id";
    final DynamicLinkParameters parameters = DynamicLinkParameters(
      link: Uri.parse(url),
      uriPrefix: "https://pollapplication.page.link",
      iosParameters: const IOSParameters(
          bundleId: "com.example.poll_application", minimumVersion: "0"),
      androidParameters: const AndroidParameters(
          packageName: "com.example.poll_application", minimumVersion: 0),
    );
